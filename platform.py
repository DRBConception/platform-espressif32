...
class Espressif32Platform(PlatformBase):
    def configure_default_packages(self, variables, targets):
        ...
        if "espidf" in frameworks:
            ...
            if "arduino" in frameworks:
                ...
                if mcu in ("esp32c3", "esp32c6", "esp32p4"):
                    self.packages.pop("toolchain-xtensa-esp-elf", None)
                else:
        ...
        if mcu in ("esp32s2", "esp32s3", "esp32c3", "esp32c6", "esp32p4"):
            # RISC-V based toolchain for ESP32C3, ESP32C6, ESP32P4, ESP32S2 ULP, ESP32S3 ULP
    ...
    def _add_dynamic_options(self, board):
        ...
        if board.get("build.mcu", "") in ("esp32c3", "esp32c6", "esp32p4", "esp32s3"):
